...
Exact dependency versions and integrity/license digests are required;
public evidence is payload-free and publication remains `not_performed`.
Its offline model/checker perform no scanner, network, provider, LLM, Git,
package-manager, or durable-state operation.
