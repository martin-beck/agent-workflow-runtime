#!/usr/bin/env python3
"""Run the AR-0093 deployment contract offline."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if (
            spec.get("task") != {"id": "AR-0093", "revision": args.expected_revision}
            or spec.get("offline_boundary", {}).get("network") != "disabled"
        ):
            raise DeploymentOperationsError("invalid_specification")
        print(
            json.dumps(
