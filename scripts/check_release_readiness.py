#!/usr/bin/env python3
"""Run the AR-0096 readiness gate without external effects."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if (
            spec.get("task") != {"id": "AR-0096", "revision": args.expected_revision}
            or spec.get("offline_boundary", {}).get("network") != "disabled"
        ):
            raise ReleaseReadinessError("invalid_specification")
        print(
            json.dumps(
